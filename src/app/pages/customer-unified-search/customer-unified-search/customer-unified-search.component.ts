...
@Component({
  selector: 'app-customer-unified-search',
  templateUrl: './customer-unified-search.component.html',
  styleUrl: './customer-unified-search.component.scss'
})
export class CustomerUnifiedSearchComponent implements OnInit {
  ...
  searchResults = CustomerUnifiedSearchComponent.searchData;
