...
import { CustomerUnifiedSearchComponent } from '../customer-unified-search/customer-unified-search.component';

@Component({
  selector: 'app-customer-unified-home',
  templateUrl: './customer-unified-home.component.html',
  styleUrl: './customer-unified-home.component.scss'
})
export class CustomerUnifiedHomeComponent {
  selectedRowIndex: number = -1;
  showForm: boolean = false;
  selectedCustomer: any;
  searchResults: any[] = CustomerUnifiedSearchComponent.searchData;
