...
@Component({
  selector: 'app-tool-unified-search',
  templateUrl: './tool-unified-search.component.html',
  styleUrl: './tool-unified-search.component.scss'
})
export class ToolUnifiedSearchComponent implements OnInit {
  ...
  searchResults = ToolUnifiedSearchComponent.searchData;
