...
import { ToolUnifiedSearchComponent } from '../tool-unified-search/tool-unified-search.component';

@Component({
  selector: 'app-tool-unified-home',
  templateUrl: './tool-unified-home.component.html',
  styleUrl: './tool-unified-home.component.scss'
})
export class ToolUnifiedHomeComponent {
  selectedRowIndex: number = -1;
  showForm: boolean = false;
  selectedCustomer: any;
  searchResults: any[] = ToolUnifiedSearchComponent.searchData;
