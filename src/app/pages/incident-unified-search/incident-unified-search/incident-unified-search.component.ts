...
@Component({
  selector: 'app-incident-unified-search',
  templateUrl: './incident-unified-search.component.html',
  styleUrl: './incident-unified-search.component.scss'
})
export class IncidentUnifiedSearchComponent implements OnInit {
  ...
  searchResults = IncidentUnifiedSearchComponent.searchData;
