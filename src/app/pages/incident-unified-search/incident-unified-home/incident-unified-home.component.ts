...
import { IncidentUnifiedSearchComponent } from '../../incident-unified-search/incident-unified-search/incident-unified-search.component';

@Component({
  selector: 'app-incident-unified-home',
  templateUrl: './incident-unified-home.component.html',
  styleUrl: './incident-unified-home.component.scss'
})
export class IncidentUnifiedHomeComponent {
  selectedRowIndex: number = -1;
  showForm: boolean = false;
  selectedCustomer: any;
  searchResults: any[] = IncidentUnifiedSearchComponent.searchData;
