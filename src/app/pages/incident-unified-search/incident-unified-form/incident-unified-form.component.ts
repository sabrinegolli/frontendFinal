...
@Component({
  selector: 'app-incident-unified-form',
  templateUrl: './incident-unified-form.component.html',
  styleUrl: './incident-unified-form.component.html'
})
export class IncidentUnifiedFormComponent {
